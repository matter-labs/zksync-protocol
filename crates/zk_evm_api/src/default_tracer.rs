...
impl<'a, A: Tracer<SupportedMemory = SimpleMemory>> Tracer for DefaultTracer<'a, A> {
    ...
    fn before_decoding(
        &mut self,
        state: VmLocalStateData<'_, 8, EncodingModeProduction>,
    ...
    fn after_decoding(
        &mut self,
        state: VmLocalStateData<'_, 8, EncodingModeProduction>,
        data: zk_evm::tracing::AfterDecodingData<8, EncodingModeProduction>,
        memory: &Self::SupportedMemory,
    ) {
    ...
    fn before_execution(
        &mut self,
        state: VmLocalStateData<'_, 8, EncodingModeProduction>,
        data: zk_evm::tracing::BeforeExecutionData<8, EncodingModeProduction>,
        memory: &Self::SupportedMemory,
    ) {
    ...
    fn after_execution(
        &mut self,
        state: VmLocalStateData<'_, 8, EncodingModeProduction>,
        data: AfterExecutionData<8, EncodingModeProduction>,
        memory: &Self::SupportedMemory,
    ) {
