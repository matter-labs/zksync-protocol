...
>(
    ...
    round_function: &R,
) -> (Vec<ModexpCircuitInstanceWitness<F>>, usize) {
    ...
    let amount_modexp_memory_queries = modexp_memory_queries.len();
    ...
    let amount_of_memory_queries_after =
        amount_of_memory_queries_before + amount_modexp_memory_queries;
